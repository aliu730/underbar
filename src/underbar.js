  ...
  _.uniq = function(array, isSorted, iterator) {
    ...
    if (isSorted) {
      _.each(array, function(element) {
        if (iterator(element) && !sortedArray.includes(element)) {
          sortedArray.push(element);
        } else if (!iterator(element)&& !sortedArray.includes(element)) {
          sortedArray.push(element);
        }
      });
	...
	_.each(array, function(element, idx, collection) {
		if (!uniqueArray.includes(iterator(element))) {
			sortedArray.push(element);
			uniqueArray.push(iterator(element));
		}
	});
	return sortedArray;
  };
